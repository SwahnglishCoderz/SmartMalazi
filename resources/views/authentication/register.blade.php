                                ...
                                @foreach($users as $user)
                                        <div class="box">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 60px"><a href="{{env('APP_URL')}}/delete/{{$user->id}}" onclick="return confirm ('Are you sure you want to delete {{$user->first_name}} {{$user->last_name}}?') " class="btn btn-danger">Delete</a></td>
                                            ...
                                            <div class="modal-dialog" >
                                                ...
                                                <div class="modal-content" id="modal">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="{{env('APP_URL')}}/update/{{$user->id}}" method="POST">
                                                            {{ csrf_field() }}
                                                            ...
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <select  class="form-control" name="lodge_id"  required>
                                                                        ...
                                                                        <option>--Select lodge--</option>
                                                                        @foreach($lodges as $lodge)
                                                                            <option value="{{$lodge->lodge_id}}" @if($user->lodge_id == $lodge->lodge_id) selected = "selected" @endif>{{$lodge->lodge_name}}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
